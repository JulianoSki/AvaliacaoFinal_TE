...
No arquivo testes.py, criamos uma classe de teste EquipmentManagerTest que herda da classe unittest.TestCase. O método setUp é executado antes de cada teste e cria uma instância do EquipmentManager.
